               ...
               navlistPanel(widths = c(2,10), id = "respiratory_pathogens_panel", #icon = icon_no_warning_fn("spa")
                            ...
                            tabPanel(title = "Other seasonal coronaviruses",
                                     ...
                                     p("Seasonal Coronaviruses (non COVID-19) are a group of viruses that typically cause mild to moderate",
                                       ...
                                       "We monitor four subtypes.  HCoV-229E (alpha) commonly causes mild upper respiratory tract infections", 
                                       "such as colds. HCoV-NL63 (alpha) causes a spectrum of illness from cold-like symptoms to croup and", 
                                       "bronchiolitis, particularly in children. HCoV-OC43 (beta) is one of the most prevalent subtypes, often", 
                                       "linked with winter outbreaks of mild respiratory illness. HCoV-HKU1 (beta) is less commonly detected", 
                                       "and can be associated with mild colds and more serious infections."),
                                     linebreaks(1),

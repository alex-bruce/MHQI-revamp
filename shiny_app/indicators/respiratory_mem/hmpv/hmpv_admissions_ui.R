...
#                                     h3(glue("Total number of influenza hospital admissions in Scotland over the last two weeks")),
                                     ...
                                     subtitle = glue("Week ending {hmpv_admissions_recent_week %>%
...
tagList(h2("Rate of acute HMPV hospital admissions in Scotland")),
...
tagList(h2("Rate of acute HMPV hospital admissions by age group")),
